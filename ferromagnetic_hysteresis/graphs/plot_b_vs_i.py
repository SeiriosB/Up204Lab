...
DATASETS = {
    "run1laminatediron": "Run 1 - Laminated Iron",
    "run1softiron": "Run 1 - Soft Iron",
    "run2laminatediron": "Run 2 - Laminated Iron",
    "run2softiron": "Run 2 - Soft Iron",
}
